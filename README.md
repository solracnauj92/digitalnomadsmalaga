...
-   Upon entering the site, users are greeted with a clean and easily readable navigation bar that directs them to the page of their choice. 
The headings and tabs being underlined immediately conveys the main points.

-   To learn more about the website owners, the user has two options: click join me and fill out the form or scroll down to social media icons. A clean navigation bar at the top of each page, and each link clearly describes the page they will end up on.

-   There is a section on the home page that describes who we are as a community and how we are funded.
The website goes on to explain why Malaga is a good choice for a digital nomad. Throughout the website, the activities and places that can be visited, as well as recommendations, are described in detail.

-   The goal is for the website to be minimal and easy to understand and navigate, with the hope of reaching out to the world and offering connections to experts and advice that a local would know and have experience with.
